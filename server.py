...
channel01 = grpc.insecure_channel('localhost:8080')
channel02 = grpc.insecure_channel('192.168.0.241:8080')
channel03 = grpc.insecure_channel('192.168.0.109:8080')
channel04 = grpc.insecure_channel('192.168.0.160:8080')
channel05 = grpc.insecure_channel('192.168.0.112:8080')
...
# User options for training main()
    while True:
        ...
        print("7. Batch training of  5 round")
        print("8. Exit")
